...
class SvgFlubberPath extends Component {
    ...
    shouldComponentUpdate(nextProps) {
        ...
        const interpolatorChanged =
            nextProps.interpolator !== this.props.interpolator;
...
SvgFlubberPath = Animated.createAnimatedComponent(SvgFlubberPath);
