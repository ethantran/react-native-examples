...
class SvgD3HierarchyTree extends Component {
    props: Props;
    generator: Layout;
    node: PointNode;
    _component: any;
...
SvgD3HierarchyTree.defaultProps = defaultProps;
SvgD3HierarchyTree = Animated.createAnimatedComponent(SvgD3HierarchyTree);
export default SvgD3HierarchyTree;
