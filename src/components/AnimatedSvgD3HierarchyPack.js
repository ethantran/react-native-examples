...
type CircularNode = d3.HierarchyCircularNode;
type Layout = d3.PackLayout;
...
function getNode(generator: Layout, root): CircularNode {
...
class SvgD3HierarchyPack extends Component {
    props: Props;
    generator: Layout;
    node: CircularNode;
    _component: any;
...
SvgD3HierarchyPack.defaultProps = defaultProps;
SvgD3HierarchyPack = Animated.createAnimatedComponent(SvgD3HierarchyPack);
export default SvgD3HierarchyPack;
